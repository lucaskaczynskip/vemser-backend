...
public class ContaCorrente {
    ...
    public boolean sacar(double valor) {
        if (valor <= retornarSaldoComChequeEspecial() && valor > 0) {
            double valorSaldoRetirado = valor - chequeEspecial;
            double valorChequeEspecialRetirado = valor - saldo;
            saldo -= valorSaldoRetirado;
            chequeEspecial -= valorChequeEspecialRetirado;
            return true;
        } else if (valor <= 0) {
