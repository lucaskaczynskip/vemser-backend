...
@Slf4j
public class ChatGeralConsumerService {
    ...
    public void consume(@Payload String message,
        ...
        log.info("{} [{}] : {}  ", chatMessageDTO.getDataCriacao().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss")), chatMessageDTO.getUsuario(), chatMessageDTO.getMensagem());
    }
}
